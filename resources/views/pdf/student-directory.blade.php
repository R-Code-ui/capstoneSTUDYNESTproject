...
<head>
    <meta charset="UTF-8">
    <style>
        @page { size: A4 portrait; margin: 20px 22px; }
        ...
        .student-card { margin: 8px 0; border: 1px solid #cbd5e1; border-radius: 6px; page-break-inside: avoid; }
        .card-title { padding: 6px 10px; background: #1d4ed8; color: #fff; font-size: 11px; font-weight: bold; }
        .details { width: 100%; border-collapse: collapse; }
        .details td { width: 50%; padding: 6px 10px; border: 1px solid #dbe4ef; vertical-align: top; }
