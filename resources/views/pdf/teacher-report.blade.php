...
<body>
    ...
    <div class="meta">
        ...
        @if($filters['grade_level']) Grade: {{ $filters['grade_level'] }} @endif
        @if($filters['subject']) Subject: {{ $filters['subject'] }} @endif
        @if($filters['trimester']) Trimester: {{ $filters['trimester'] }} @endif
    </div>
        ...
        <div class="summary">
            @foreach($summary as $key => $value)
                <div class="summary-item">
                    ...
                    <div class="summary-value">{{ is_numeric($value) ? round($value) : $value }}</div>
                </div>
            @endforeach
        </div>
    @endif
                ...
                @foreach($data as $row)
                    <tr>
                        @foreach($row as $value)
                            <td>{{ is_numeric($value) ? round($value) : $value ?? '—' }}</td>
                        @endforeach
                    </tr>
                @endforeach
            </tbody>
    ...
    <div class="footer">Generated by StudyNest – Teacher Reports</div>
</body>
</html>
