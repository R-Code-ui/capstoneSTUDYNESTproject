    ...
    useEffect(() => {
        ...
        const interval = setInterval(() => {
            setProgress((prev) => {
                ...
                return Math.max(0, prev - (100 / (duration / 100)));
            });
        }, 100);
            ...
            <div className={`pointer-events-auto relative rounded-lg border ${variant.border} shadow-lg ${variant.bg} overflow-hidden`}>
                <div className="flex items-start p-4">
                    ...
                    <button
                        ...
                        className={`ml-4 flex-shrink-0 inline-flex text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400 transition-colors`}
                    >
                ...
                {/* Progress bar */}
                <div
                    className={`h-1 ${variant.progress} transition-all duration-100 ease-linear`}
