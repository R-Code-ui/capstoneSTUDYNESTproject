...
import { ChatBubbleLeftRightIcon, LockClosedIcon, UserGroupIcon } from '@heroicons/react/24/outline';

export default function MessageGroupList({ groups = [], routeName, canCreate = false }) {
    return (
        <section className="mb-8">
            <div className="flex items-center justify-between mb-3">
                ...
                {canCreate && (
                    <Link
                        href={route('teacher.messages.groups.create')}
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                    {groups.map((group) => (
                        <Link
                            ...
                            className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:border-blue-300 hover:shadow-md"
                        >
