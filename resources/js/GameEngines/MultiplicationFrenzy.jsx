...
export default function MultiplicationFrenzy({ content, onComplete, onExit, onProgress, initialState }) {
        ...
        >
            <div className="bg-gradient-to-br from-amber-50 to-yellow-50 p-6 rounded-3xl border border-amber-100 shadow-inner">
                <div className="flex flex-col items-center gap-8">
                    <div className="bg-white px-8 py-5 rounded-full shadow-lg border-2 border-amber-100 flex items-center gap-6">
                        <span className="text-3xl font-black text-amber-600">
                            {round.factor1} × {round.factor2}
                        </span>
                    ...
                    <div className="grid grid-cols-2 gap-4 w-full max-w-sm">
                        {round.choices.map((choice) => {
                            ...
                            const isCorrect = feedback === 'correct' && choice === round.product;
                            let bg = 'bg-white border-amber-200 text-amber-800';
