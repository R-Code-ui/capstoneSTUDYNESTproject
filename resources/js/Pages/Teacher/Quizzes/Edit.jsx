    ...
    return (
        ...
        >
            ...
            <style>{`
                ...
                .quiz-form-shell input, .quiz-form-shell select, .quiz-form-shell textarea { scroll-margin-block: 7rem; }
                .studynest-layout.theme-dark .quiz-form-actions { background-color: rgb(15 23 42 / 0.96); border-color: rgb(51 65 85); }
            `}</style>
                ...
                <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
                    <div className="quiz-form-shell bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                        ...
                        <form onSubmit={handleSubmit} onFocusCapture={keepFocusedFieldVisible} className="space-y-6 p-4 pb-24 sm:p-6 sm:pb-6">
                            ...
                            {/* Actions */}
                            <div className="quiz-form-actions sticky bottom-3 z-10 -mx-4 grid grid-cols-2 gap-3 border-t border-gray-200 bg-white/95 px-4 pb-[max(0.25rem,env(safe-area-inset-bottom))] pt-4 shadow-[0_-10px_18px_-18px_rgba(15,23,42,0.55)] backdrop-blur sm:static sm:mx-0 sm:flex sm:justify-end sm:bg-transparent sm:px-0 sm:pb-0 sm:shadow-none">
                                <SecondaryButton type="button" className="w-full justify-center sm:w-auto" onClick={() => router.visit(route('teacher.quizzes.index'))}>
                                    Cancel
                                </SecondaryButton>
