...
import { BookOpenIcon, ChartBarIcon, ClipboardDocumentCheckIcon, ClipboardDocumentListIcon, DocumentTextIcon, UsersIcon } from '@heroicons/react/24/outline';
...
const reports = [
    ...
    { key: 'lesson_report', title: 'Lesson Report', description: 'Published lessons by subject, week, term, and school year.', icon: BookOpenIcon },
...
export default function TeacherReports({ assigned_grades = [], subjects = [], school_years = [], trimesters = [] }) {
    ...
    const needsStudentStatus = reportType !== 'lesson_report';
