...
export default function GamesEdit({
    ...
    const [selectedGrade, setSelectedGrade] = useState(game.grade_level || '');
    const [selectedType, setSelectedType] = useState(game.game_type || 'literacy');
    ...
    const { data, setData, errors, put } = useForm({
        ...
        max_attempts: game.max_attempts || 5,
    ...
    const handleSubmit = (e) => {
        ...
        put(route('teacher.games.update', game.id), {
            data: {
                ...data,
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                                            ...
                                            availableGames.map((gameTitle) => (
                                                <button
                                                    ...
                                                    className={`
                                                        ...
                                                        game-choice ${data.game_title === gameTitle
                            ...
                            <div className="border-t border-gray-200 pt-4">
                                ...
                                <PublishingOptions
                                    ...
                                    setData={setData}
                                    errors={errors}
                                    locked={['published', 'archived'].includes(game.status)}
                                />
                            </div>
