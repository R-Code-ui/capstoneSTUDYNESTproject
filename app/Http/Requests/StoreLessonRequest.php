...
class StoreLessonRequest extends FormRequest
{
    ...
    {
        return auth()->user()->hasPermissionTo('lesson.create');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'resources.*' => 'file|mimes:pdf,jpg,jpeg,png,doc,docx,ppt,pptx,mp4|max:102400',
        ];
    }
    ...
    protected function prepareForValidation(): void
    {
        ...
        if ($this->has('grade_level') && !in_array($this->grade_level, $assignedGrades)) {
            // If grade_level is not assigned, throw validation error
            $this->merge([
                'grade_level' => null, // This will trigger the required validation
            ]);
        }
    }
}
